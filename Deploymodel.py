...
label_encoder_bisnis = joblib.load(r"label_encoder_bisnis.pkl")
preprocessing_bisnis = joblib.load(r"Preprocessing_bisnis_pipeline.pkl")
model_bisnis = joblib.load(r"model_bisnis.pkl")
